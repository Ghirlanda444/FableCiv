...
const files = ['version.js', 'assetlist.js', 'core/rng.js', 'core/hex.js', 'data/terrain.js', 'data/civs.js', 'data/civs2.js', 'data/leanings.js', 'data/religion.js', 'data/citystates.js', 'data/cultures.js', 'data/palace.js', 'data/greatpeople.js', 'data/units.js', 'data/buildings.js', 'data/techs.js', 'data/mastery.js', 'data/quotes.js', 'core/mapgen.js', 'core/game.js', 'core/units.js', 'core/religion.js', 'core/citystates.js', 'core/diplomacy.js', 'core/palace.js', 'core/greatpeople.js', 'core/ai.js'];
