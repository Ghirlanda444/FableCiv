  ...
  AU.CIVS = [
    { id: 'rome', name: 'Rome', adj: 'Roman', difficulty: 'easy', bias: ['hills', 'river'], color: '#8b1a1a', color2: '#f5d76e',
      ...
      leaders: [
        ...
        L('augustus', 'Augustus', 'Princeps', 'Marble City', 'Wonders cost 20% less and each Wonder yields +2 Heritage. +1 Happiness in every settlement.', { wonderCostMult: 0.8, culturePerWonder: 2, happinessBonus: 1 }, { aggression: 0.3, expansion: 0.6, science: 0.5, culture: 0.8 }),
    ...
    { id: 'japan', name: 'Japan', adj: 'Japanese', difficulty: 'easy', bias: ['coast'], color: '#f2f2f2', color2: '#c0392b',
      ...
      leaders: [
        ...
        L('meiji', 'Emperor Meiji', 'Emperor', 'Restoration', 'Every Spark also grants 20% of the technology\'s cost in Knowledge. Every building yields +1 Knowledge in Cities.', { eurekaDiscount: 0.2, cityBuildingScience: 1 }, { aggression: 0.35, expansion: 0.5, science: 0.9, culture: 0.6 })
      ] },
    ...
    { id: 'america', name: 'America', adj: 'American', difficulty: 'easy', bias: ['plains', 'river'], color: '#1f3f8f', color2: '#ffffff',
      ...
      leaders: [
        ...
        L('franklin', 'Benjamin Franklin', 'Statesman', 'Lightning Rod', 'Libraries and Universities yield +2 Knowledge. Gain 40 Gold whenever you learn a technology.', { buildingBonus: { library: { science: 2 }, university: { science: 2 } }, techGold: 40 }, { aggression: 0.2, expansion: 0.5, science: 0.9, culture: 0.6 })
      ] },
    ...
    { id: 'india', name: 'India', adj: 'Indian', difficulty: 'easy', bias: ['river', 'grassland'], color: '#f39c12', color2: '#1a5e2a',
      ...
      leaders: [
        ...
        L('ashoka', 'Ashoka', 'Emperor', 'Edicts of Stone', '+2 Heritage and +1 Devotion per settlement. Capturing a settlement grants +150 Heritage; conquered settlements keep their buildings.', { culturePerSettlement: 2, faithPerSettlement: 1, captureCulture: 150, captureKeepBuildings: true }, { aggression: 0.5, expansion: 0.6, science: 0.5, culture: 0.8 }),
    ...
    { id: 'zulu', name: 'Zulu', adj: 'Zulu', difficulty: 'medium', bias: ['grassland', 'hills'], color: '#3a2c1c', color2: '#e74c3c',
      ...
      leaders: [
        L('shaka', 'Shaka', 'King', 'Horns of the Buffalo', 'Melee units +6 Strength when attacking. Killing a unit grants +10 Heritage.', { meleeAttackBonus: 6, culturePerKill: 10 }, { aggression: 0.95, expansion: 0.5, science: 0.2, culture: 0.3 }),
    ...
    { id: 'persia', name: 'Persia', adj: 'Persian', difficulty: 'easy', bias: ['plains', 'hills'], color: '#7b2f8a', color2: '#f5cba7',
      ...
      leaders: [
        ...
        L('darius', 'Darius I', 'Shahanshah', 'Satrapies', 'Towns yield +3 Gold and specialized Towns +1 Knowledge. Purchases cost 10% less. +1 Gold per settlement following your religion.', { townYields: { gold: 3 }, specializedTownYields: { science: 1 }, purchaseMult: 0.9, goldPerFollowerSettlement: 1 }, { aggression: 0.4, expansion: 0.8, science: 0.6, culture: 0.5 })
      ] },
    ...
    { id: 'egypt', name: 'Egypt', adj: 'Egyptian', difficulty: 'medium', bias: ['river', 'desert'], color: '#d4ac0d', color2: '#1b2631',
      ...
      leaders: [
        ...
        L('ramses', 'Ramses II', 'Pharaoh', 'Builder of Monuments', 'Wonders cost 25% less and each Wonder yields +1 Happiness, +2 Heritage and +2 Devotion.', { wonderCostMult: 0.75, happinessPerWonder: 1, culturePerWonder: 2, faithPerWonder: 2 }, { aggression: 0.5, expansion: 0.5, science: 0.4, culture: 0.9 }),
    ...
    { id: 'celts', name: 'Celts', adj: 'Celtic', difficulty: 'medium', bias: ['forest'], color: '#1e6b3a', color2: '#e0e0e0',
      ...
      leaders: [
        ...
        L('vercingetorix', 'Vercingetorix', 'Chieftain', 'Oppidum', 'Settlements on Hills +5 defense, +1 Production and +1 Heritage. Fort Towns heal units fully each turn.', { settlementSiteBonus: [{ when: 'hills', yields: { production: 1, culture: 1 } }], hillsDefense: 5, fortFullHeal: true }, { aggression: 0.5, expansion: 0.6, science: 0.4, culture: 0.5 })
      ] },
    ...
    { id: 'arabia', name: 'Arabia', adj: 'Arabian', difficulty: 'medium', bias: ['desert'], color: '#1a7a4a', color2: '#f4f4f4',
      ...
      leaders: [
        ...
        L('harun', 'Harun al-Rashid', 'Caliph', 'House of Wisdom', '+10% Knowledge; each Wonder yields +3 Knowledge; gain a free technology when you build your first Library.', { yieldMult: { science: 1.1 }, sciencePerWonder: 3, freeTechOnBuilding: 'library' }, { aggression: 0.3, expansion: 0.6, science: 0.9, culture: 0.6 })
      ] },
    ...
    { id: 'france', name: 'France', adj: 'French', difficulty: 'medium', bias: ['grassland', 'river'], color: '#2c3e9e', color2: '#f5f5f5',
      ...
      leaders: [
        ...
        L('louis', 'Louis XIV', 'Sun King', 'Versailles', '+2 Heritage per settlement, capital +20% Heritage and Gold; Theocracy and Monarchy give +2 extra Happiness.', { culturePerSettlement: 2, capitalMult: { culture: 1.2, gold: 1.2 }, monarchHappiness: 2 }, { aggression: 0.5, expansion: 0.5, science: 0.5, culture: 0.9 }),
    ...
    { id: 'maya', name: 'Maya', adj: 'Mayan', difficulty: 'hard', bias: ['jungle'], color: '#117864', color2: '#fdfefe',
      ...
      leaders: [
        ...
        L('pakal', 'K\'inich Janaab\' Pakal', 'Ajaw', 'Temple of Inscriptions', 'Wonders cost 15% less; each Wonder yields +3 Knowledge and +1 Happiness. Starts with a free Pantheon.', { wonderCostMult: 0.85, sciencePerWonder: 3, happinessPerWonder: 1, freePantheon: true }, { aggression: 0.3, expansion: 0.5, science: 0.8, culture: 0.7 })
      ] },
    ...
    { id: 'greece', name: 'Greece', adj: 'Greek', difficulty: 'easy', bias: ['coast', 'hills'], color: '#1a5276', color2: '#f4f6f7',
      ...
      leaders: [
        ...
        L('alexander', 'Alexander', 'King of Macedon', 'To the Ends of the World', 'No war weariness. Capturing a settlement grants a free technology boost of 60 Knowledge; cavalry +4 Strength.', { warWearinessMult: 0, captureScience: 60, cavalryBonus: 4 }, { aggression: 0.95, expansion: 0.6, science: 0.5, culture: 0.4 })
      ] },
    ...
    { id: 'germany', name: 'Germany', adj: 'German', difficulty: 'easy', bias: ['river', 'forest'], color: '#4d4d4d', color2: '#f1c40f',
      ...
      leaders: [
        ...
        L('frederick', 'Frederick the Great', 'King of Prussia', 'Enlightened Despot', 'Technologies cost 10% less; +10% Knowledge; Oligarchy and Autocracy give +2 extra Combat Strength.', { techCostMult: 0.9, yieldMult: { science: 1.1 }, despotCombat: 2 }, { aggression: 0.6, expansion: 0.5, science: 0.8, culture: 0.6 })
      ] },
    ...
    { id: 'russia', name: 'Russia', adj: 'Russian', difficulty: 'medium', bias: ['tundra'], color: '#5d6d7e', color2: '#f4d03f',
      ...
      leaders: [
        ...
        L('catherine', 'Catherine the Great', 'Empress', 'Enlightened Court', '+2 Heritage per settlement; Museums and Amphitheaters +2 Heritage; purchases 10% cheaper.', { culturePerSettlement: 2, buildingBonus: { museum: { culture: 2 }, amphitheater: { culture: 2 } }, purchaseMult: 0.9 }, { aggression: 0.4, expansion: 0.7, science: 0.6, culture: 0.8 }),
    ...
    { id: 'spain', name: 'Spain', adj: 'Spanish', difficulty: 'medium', bias: ['coast', 'hills'], color: '#c0392b', color2: '#f7dc6f',
      ...
      leaders: [
        ...
        L('philip', 'Philip II', 'King', 'Spanish Armada', 'Naval units +6 Strength and cost 20% less; Missions yield +2 extra Heritage.', { navalBonus: 6, navalCostMult: 0.8, buildingBonus: { shrine: { culture: 2 } } }, { aggression: 0.7, expansion: 0.6, science: 0.4, culture: 0.6 })
      ] },
    ...
    { id: 'vietnam', name: 'Vietnam', adj: 'Vietnamese', difficulty: 'hard', bias: ['jungle'], color: '#a93226', color2: '#f9e79f',
      ...
      leaders: [
        ...
        L('leloi', 'Lê Lợi', 'Emperor', 'Lam Sơn', 'Units +1 Movement in Forest and Rainforest (normal cost); units heal +15 in your territory; killing a unit grants +8 Heritage.', { forestMoveCost: 1, healBonusHome: 15, culturePerKill: 8 }, { aggression: 0.6, expansion: 0.6, science: 0.4, culture: 0.6 })
      ] },
    ...
    { id: 'ethiopia', name: 'Ethiopia', adj: 'Ethiopian', difficulty: 'medium', bias: ['hills', 'mountain'], color: '#7d6608', color2: '#27ae60',
      ...
      leaders: [
        ...
        L('zara', 'Zara Yaqob', 'Emperor', 'Book of Light', '+2 Heritage per settlement; Shrines yield +2 Knowledge; +1 Happiness per settlement; +25% Devotion.', { culturePerSettlement: 2, buildingBonus: { shrine: { science: 2 } }, happinessBonus: 1, yieldMult: { faith: 1.25 } }, { aggression: 0.3, expansion: 0.5, science: 0.6, culture: 0.8 })
      ] },
    ...
    { id: 'babylon', name: 'Babylon', adj: 'Babylonian', difficulty: 'medium', bias: ['river', 'marsh'], color: '#6c3483', color2: '#f8c471',
      ...
      leaders: [
        L('hammurabi', 'Hammurabi', 'King', 'Code of Laws', 'Gain a free Civic when you build your first Monument; +2 Heritage per settlement; Walls +2 defense.', { freeCivicOnBuilding: 'monument', culturePerSettlement: 2, cityDefense: 2 }, { aggression: 0.4, expansion: 0.6, science: 0.7, culture: 0.7 }),
