...
(function (AU) {
  ...
  AU.CIVS = [
    { id: 'rome', name: 'Rome', adj: 'Roman', difficulty: 'easy', bias: ['hills', 'river'], color: '#8b1a1a', color2: '#f5d76e',
      ...
      leaders: [
        L('trajan', 'Trajan', 'Optimus Princeps', 'Column of Victory', 'Captured settlements keep all their buildings and lose no population. +100 Gold per capture.', { captureKeepBuildings: true, captureNoPopLoss: true, captureGold: 100 }, { aggression: 0.75, expansion: 0.7, science: 0.4, culture: 0.4 }),
    ...
    { id: 'japan', name: 'Japan', adj: 'Japanese', difficulty: 'easy', bias: ['coast'], color: '#f2f2f2', color2: '#c0392b',
      ...
      leaders: [
        L('tokugawa', 'Tokugawa Ieyasu', 'Shogun', 'Sakoku', 'Units +5 Strength inside your borders. Settlements +3 defense. Towns turn Production into Gold at 125% instead of 100%.', { combatBonusHome: 5, cityDefense: 3, townGoldMult: 1.25 }, { aggression: 0.3, expansion: 0.5, science: 0.6, culture: 0.6 }),
        L('hojo', 'Hojo Tokimune', 'Shikken', 'Kamikaze', 'Naval units +6 Strength and +1 Movement. Units +5 Strength while on Coast water.', { navalBonus: 6, navalMoves: 1, combatBonusCoast: 5 }, { aggression: 0.5, expansion: 0.5, science: 0.5, culture: 0.5 }),
        L('meiji', 'Emperor Meiji', 'Emperor', 'Restoration', 'Every Spark also adds 20% of that technology\'s cost to your research. Buildings in Cities yield +1 Knowledge each.', { eurekaDiscount: 0.2, cityBuildingScience: 1 }, { aggression: 0.35, expansion: 0.5, science: 0.9, culture: 0.6 })
      ] },
    ...
    { id: 'china', name: 'China', adj: 'Chinese', difficulty: 'easy', bias: ['river', 'grassland'], color: '#2e8b57', color2: '#f7e04b',
      ...
      ub: { id: 'great_wall_tower', name: 'Great Wall', replaces: 'walls', yields: { culture: 2, gold: 1 }, desc: '+2 Heritage, +1 Gold' },
      ...
      leaders: [
        L('qin', 'Qin Shi Huang', 'First Emperor', 'Terracotta Legions', 'Wonders cost 20% less. Every settlement gets free Walls once you know Masonry.', { wonderCostMult: 0.8, freeBuildingWithTech: { walls: 'masonry' } }, { aggression: 0.4, expansion: 0.6, science: 0.6, culture: 0.6 }),
        L('taizong', 'Emperor Taizong', 'Emperor', 'Zhenguan Era', '+10% Knowledge and Heritage. +1 Knowledge per settlement. Cavalry +2 Strength.', { yieldMult: { science: 1.1, culture: 1.1 }, sciencePerSettlement: 1, classBonus: { cavalry: 2 } }, { aggression: 0.45, expansion: 0.6, science: 0.8, culture: 0.7 }),
        L('wu', 'Wu Zetian', 'Empress', 'Silk and Ink', 'Each worked Luxury resource yields +2 Heritage. +1 Happiness in every settlement.', { luxuryCulture: 2, happinessBonus: 1 }, { aggression: 0.3, expansion: 0.6, science: 0.7, culture: 0.8 }),
        L('kublai', 'Kublai Khan', 'Emperor', 'Grand Canal', 'Towns send 50% more surplus Food to Cities. Specialized Towns +2 Gold. Cavalry +3 Strength.', { townFoodMult: 1.5, specializedTownYields: { gold: 2 }, cavalryBonus: 3 }, { aggression: 0.6, expansion: 0.7, science: 0.5, culture: 0.4 })
      ] },
    ...
    { id: 'america', name: 'America', adj: 'American', difficulty: 'easy', bias: ['plains', 'river'], color: '#1f3f8f', color2: '#ffffff',
      ...
      leaders: [
        L('roosevelt', 'Theodore Roosevelt', 'President', 'Big Stick', 'Units +5 Strength on the continent of your capital. Other leaders start friendlier toward you.', { combatBonusHomeContinent: 5, attitudeBonus: 10 }, { aggression: 0.5, expansion: 0.7, science: 0.6, culture: 0.6 }),
        L('lincoln', 'Abraham Lincoln', 'President', 'A House United', 'Cities +2 Production. +1 Happiness in every settlement. 4 more units are free of upkeep.', { citySiteYields: { production: 2 }, happinessBonus: 1, freeUpkeep: 4 }, { aggression: 0.35, expansion: 0.6, science: 0.6, culture: 0.5 }),
        L('franklin', 'Benjamin Franklin', 'Statesman', 'Lightning Rod', 'Libraries and Universities +2 Knowledge. +40 Gold whenever you learn a technology.', { buildingBonus: { library: { science: 2 }, university: { science: 2 } }, techGold: 40 }, { aggression: 0.2, expansion: 0.5, science: 0.9, culture: 0.6 })
      ] },

    { id: 'india', name: 'India', adj: 'Indian', difficulty: 'easy', bias: ['river', 'grassland'], color: '#f39c12', color2: '#1a5e2a',
      ability: { name: 'Dharma', desc: '+1 Happiness in every settlement. Specialized Towns yield +2 Heritage.', fx: { happinessBonus: 1, specializedTownYields: { culture: 2 } } },
      ...
      leaders: [
        L('gandhi', 'Gandhi', 'Mahatma', 'Satyagraha', 'Settlements grow 20% faster. Unhappiness never reduces your yields. Other leaders start friendlier toward you.', { growthMult: 1.2, noUnhappinessPenalty: true, attitudeBonus: 15 }, { aggression: 0.1, expansion: 0.6, science: 0.6, culture: 0.7 }),
        L('ashoka', 'Ashoka', 'Emperor', 'Edicts of Stone', '+2 Heritage and +1 Devotion per settlement. Capturing a settlement grants +150 Heritage and keeps its buildings.', { culturePerSettlement: 2, faithPerSettlement: 1, captureCulture: 150, captureKeepBuildings: true }, { aggression: 0.5, expansion: 0.6, science: 0.5, culture: 0.8 }),
        L('akbar', 'Akbar', 'Padishah', 'Din-i Ilahi', 'Each worked Luxury resource gives +1 extra Happiness. Purchases in Towns cost 20% less.', { luxuryHappinessBonus: 1, townPurchaseMult: 0.8 }, { aggression: 0.4, expansion: 0.7, science: 0.6, culture: 0.6 })
      ] },
    ...
    { id: 'mongolia', name: 'Mongolia', adj: 'Mongol', difficulty: 'hard', bias: ['plains', 'grassland'], color: '#5b3a1e', color2: '#e8d5a3',
      ...
      leaders: [
        ...
        L('mandukhai', 'Mandukhai', 'Khatun', 'Unifier of the Clans', '+1 Happiness in every settlement. Units heal +10 everywhere. Units gain experience 50% faster.', { happinessBonus: 1, healBonusAll: 10, xpMult: 1.5 }, { aggression: 0.6, expansion: 0.7, science: 0.4, culture: 0.4 })
      ] },
    ...
    { id: 'persia', name: 'Persia', adj: 'Persian', difficulty: 'easy', bias: ['plains', 'hills'], color: '#7b2f8a', color2: '#f5cba7',
      ...
      ut: { id: 'satrapy', name: 'Satrapy', icon: '👑', minPop: 4, desc: 'A tribute town: +4 Gold, +1 Gold per worked tile, +2 Heritage.', fx: { flat: { gold: 4, culture: 2 }, tileYields: { when: 'all', yields: { gold: 1 } } } },
      ...
      leaders: [
        L('cyrus', 'Cyrus', 'King of Kings', 'Cylinder of Mercy', 'Captured settlements keep their buildings and lose no population, and get +2 Happiness.', { captureKeepBuildings: true, captureNoPopLoss: true, capturedHappiness: 2 }, { aggression: 0.6, expansion: 0.7, science: 0.5, culture: 0.6 }),
        L('darius', 'Darius I', 'Shahanshah', 'Satrapies', 'Towns +3 Gold, specialized Towns also +1 Knowledge. Purchases cost 10% less. +1 Gold per settlement that follows your religion.', { townYields: { gold: 3 }, specializedTownYields: { science: 1 }, purchaseMult: 0.9, goldPerFollowerSettlement: 1 }, { aggression: 0.4, expansion: 0.8, science: 0.6, culture: 0.5 })
      ] },

    { id: 'egypt', name: 'Egypt', adj: 'Egyptian', difficulty: 'medium', bias: ['river', 'desert'], color: '#d4ac0d', color2: '#1b2631',
      ability: { name: 'Gift of the Nile', desc: 'Worked River tiles yield +1 Food. Settlements on rivers +1 Production and +1 Heritage.', fx: { tileBonus: [{ when: 'river', yields: { food: 1 } }], settlementSiteBonus: [{ when: 'river', yields: { production: 1, culture: 1 } }] } },
      ...
      ui: { id: 'sphinx', name: 'Sphinx', icon: '🗿', replaces: 'farm', when: 'desert', yields: { culture: 2, faith: 1 }, desc: 'desert farms become monuments: +2 Heritage, +1 Devotion' },
    ...
    { id: 'arabia', name: 'Arabia', adj: 'Arabian', difficulty: 'medium', bias: ['desert'], color: '#1a7a4a', color2: '#f4f4f4',
      ...
      leaders: [
        L('saladin', 'Saladin', 'Sultan', 'Righteous Blade', 'Units +5 Strength within 3 tiles of your settlements. Capturing a settlement heals your units nearby.', { nearHomeBonus: 5, captureHeal: true }, { aggression: 0.6, expansion: 0.6, science: 0.6, culture: 0.5 }),
        L('harun', 'Harun al-Rashid', 'Caliph', 'House of Wisdom', '+10% Knowledge. Each Wonder yields +3 Knowledge. Your first Library grants a free technology.', { yieldMult: { science: 1.1 }, sciencePerWonder: 3, freeTechOnBuilding: 'library' }, { aggression: 0.3, expansion: 0.6, science: 0.9, culture: 0.6 })
      ] },
    ...
    { id: 'england', name: 'England', adj: 'English', difficulty: 'medium', bias: ['coast'], color: '#b71c1c', color2: '#ffffff',
      ...
      leaders: [
        L('victoria', 'Victoria', 'Queen', 'Workshop of the World', 'Workshops and Factories +3 Production. Cities +10% Production.', { buildingBonus: { factory: { production: 3 }, workshop: { production: 3 } }, cityYieldMult: { production: 1.1 } }, { aggression: 0.5, expansion: 0.7, science: 0.7, culture: 0.5 }),
        L('elizabeth', 'Elizabeth I', 'Queen', 'Sea Dogs', 'Naval units +5 Strength. Kills at sea grant +60 Gold. Dispersing an Inchibil camp gives triple Gold.', { navalBonus: 5, campGoldMult: 3, navalKillGold: 60 }, { aggression: 0.6, expansion: 0.6, science: 0.6, culture: 0.6 }),
        L('churchill', 'Winston Churchill', 'Prime Minister', 'Finest Hour', 'Settlements +5 defense and they shoot at attackers even without Walls. Units +5 Strength when defending.', { cityDefense: 5, cityAttackNoWalls: true, defenseBonus: 5 }, { aggression: 0.4, expansion: 0.5, science: 0.6, culture: 0.5 })
      ] },
    ...
    { id: 'aztec', name: 'Aztec', adj: 'Aztec', difficulty: 'medium', bias: ['jungle', 'lake'], color: '#0e6655', color2: '#f0b27a',
      ...
      leaders: [
        L('montezuma', 'Montezuma', 'Tlatoani', 'Tribute of Blood', 'Each worked Luxury resource gives +1 extra Happiness. Capturing a settlement grants +200 Gold.', { luxuryHappinessBonus: 1, captureGold: 200 }, { aggression: 0.85, expansion: 0.5, science: 0.3, culture: 0.5 }),
        L('itzcoatl', 'Itzcoatl', 'Tlatoani', 'Triple Alliance', 'Capital +15% Production. Units cost 15% less, Pioneers 20% less.', { capitalMult: { production: 1.15 }, unitCostMult: 0.85, settlerCostMult: 0.8 }, { aggression: 0.6, expansion: 0.8, science: 0.4, culture: 0.4 })
      ] },
    ...
    { id: 'inca', name: 'Inca', adj: 'Incan', difficulty: 'hard', bias: ['mountain', 'hills'], color: '#a04000', color2: '#f9e79f',
      ...
      leaders: [
        ...
        L('huayna', 'Huayna Capac', 'Sapa Inca', 'Mit\'a Levy', 'Towns turn Production into Gold at 130% instead of 100% and grow 15% faster. Pioneers cost 15% less.', { townGoldMult: 1.3, townGrowthMult: 1.15, settlerCostMult: 0.85 }, { aggression: 0.4, expansion: 0.9, science: 0.4, culture: 0.4 })
      ] },
    ...
    { id: 'greece', name: 'Greece', adj: 'Greek', difficulty: 'easy', bias: ['coast', 'hills'], color: '#1a5276', color2: '#f4f6f7',
      ...
      leaders: [
        L('pericles', 'Pericles', 'Strategos', 'Golden Age of Athens', 'Every Insight also adds 20% of that civic\'s cost to your Heritage. Each Wonder yields +2 Knowledge and +2 Heritage.', { inspirationDiscount: 0.2, sciencePerWonder: 2, culturePerWonder: 2 }, { aggression: 0.3, expansion: 0.5, science: 0.7, culture: 0.9 }),
        L('leonidas', 'Leonidas', 'King', 'Thermopylae', 'Anti-cavalry +6 Strength. +10 Strength when defending on Hills. New units start at level 1.', { classBonus: { antcav: 6 }, hillsDefenseBonus: 10, unitsStartXp: 5 }, { aggression: 0.7, expansion: 0.4, science: 0.3, culture: 0.4 }),
        L('alexander', 'Alexander', 'King of Macedon', 'To the Ends of the World', 'No war weariness. Capturing a settlement adds +60 Knowledge to your research. Cavalry +4 Strength.', { warWearinessMult: 0, captureScience: 60, cavalryBonus: 4 }, { aggression: 0.95, expansion: 0.6, science: 0.5, culture: 0.4 })
      ] },
    ...
    { id: 'germany', name: 'Germany', adj: 'German', difficulty: 'easy', bias: ['river', 'forest'], color: '#4d4d4d', color2: '#f1c40f',
      ...
      leaders: [
        ...
        L('bismarck', 'Otto von Bismarck', 'Chancellor', 'Blood and Iron', 'Units cost 20% less. Units built in a settlement with Barracks or a Military Academy get +2 Strength. +5 Strength against settlements.', { unitCostMult: 0.8, unitStrengthFromBarracks: 2, vsSettlements: 5 }, { aggression: 0.7, expansion: 0.6, science: 0.6, culture: 0.4 }),
        L('frederick', 'Frederick the Great', 'King of Prussia', 'Enlightened Despot', 'Technologies cost 10% less. +10% Knowledge. Under Oligarchy or Autocracy all units +2 Strength.', { techCostMult: 0.9, yieldMult: { science: 1.1 }, despotCombat: 2 }, { aggression: 0.6, expansion: 0.5, science: 0.8, culture: 0.6 })
      ] },
    ...
    { id: 'spain', name: 'Spain', adj: 'Spanish', difficulty: 'medium', bias: ['coast', 'hills'], color: '#c0392b', color2: '#f7dc6f',
      ...
      ub: { id: 'mission', name: 'Mission', replaces: 'shrine', yields: { culture: 2, science: 1, happiness: 1 }, desc: '+2 Heritage, +1 Knowledge, +1 Happiness' },
      ...
      leaders: [
        ...
        L('philip', 'Philip II', 'King', 'Spanish Armada', 'Naval units +6 Strength and cost 20% less. Shrines yield +2 extra Heritage.', { navalBonus: 6, navalCostMult: 0.8, buildingBonus: { shrine: { culture: 2 } } }, { aggression: 0.7, expansion: 0.6, science: 0.4, culture: 0.6 })
      ] },
    ...
    { id: 'ottoman', name: 'Ottomans', adj: 'Ottoman', difficulty: 'medium', bias: ['coast', 'hills'], color: '#1b4f3f', color2: '#e8e8e8',
      ...
      leaders: [
        L('mehmed', 'Mehmed II', 'Sultan', 'Conqueror', 'Siege units +10 Strength against settlements. Capturing a capital grants +300 Gold.', { classBonusVsSettlements: { siege: 10 }, captureCapitalGold: 300 }, { aggression: 0.9, expansion: 0.6, science: 0.5, culture: 0.5 }),
        L('suleiman', 'Suleiman', 'Kanuni', 'Lawgiver', '+2 Happiness in every settlement. +10% Gold. Captured settlements get +3 Happiness.', { happinessBonus: 2, yieldMult: { gold: 1.1 }, capturedHappiness: 3 }, { aggression: 0.6, expansion: 0.6, science: 0.6, culture: 0.7 })
      ] },
    ...
    { id: 'vietnam', name: 'Vietnam', adj: 'Vietnamese', difficulty: 'hard', bias: ['jungle'], color: '#a93226', color2: '#f9e79f',
      ...
      leaders: [
        L('trung', 'Trưng Trắc', 'Queen', 'Uprising', 'Units +8 Strength when defending inside your borders. Every settlement gets free Walls once you know Masonry.', { homeDefenseBonus: 8, freeBuildingWithTech: { walls: 'masonry' } }, { aggression: 0.4, expansion: 0.5, science: 0.4, culture: 0.6 }),
        L('leloi', 'Lê Lợi', 'Emperor', 'Lam Sơn', 'Forest and Rainforest cost 1 Movement for your units. Units heal +15 inside your borders. Every kill grants +8 Heritage.', { forestMoveCost: 1, healBonusHome: 15, culturePerKill: 8 }, { aggression: 0.6, expansion: 0.6, science: 0.4, culture: 0.6 })
      ] },
    ...
    { id: 'ethiopia', name: 'Ethiopia', adj: 'Ethiopian', difficulty: 'medium', bias: ['hills', 'mountain'], color: '#7d6608', color2: '#27ae60',
      ...
      leaders: [
        L('menelik', 'Menelik II', 'Emperor', 'Victory at Adwa', 'Units +6 Strength when defending on Hills, and +5 against units whose empire comes from another continent.', { hillsDefenseBonus: 6, combatBonusVsInvaders: 5 }, { aggression: 0.4, expansion: 0.6, science: 0.5, culture: 0.5 }),
        L('zara', 'Zara Yaqob', 'Emperor', 'Book of Light', '+2 Heritage and +1 Happiness per settlement. Shrines +2 Knowledge. +25% Devotion.', { culturePerSettlement: 2, buildingBonus: { shrine: { science: 2 } }, happinessBonus: 1, yieldMult: { faith: 1.25 } }, { aggression: 0.3, expansion: 0.5, science: 0.6, culture: 0.8 })
      ] },
    ...
    { id: 'norway', name: 'Norway', adj: 'Norse', difficulty: 'hard', bias: ['coast'], color: '#1f618d', color2: '#e74c3c',
      ...
      leaders: [
        L('harald', 'Harald Hardrada', 'King', 'Last Viking', 'Units +5 Strength while on Coast water (attacking from ships). Every kill grants +20 Gold.', { combatBonusCoast: 5, goldPerKill: 20 }, { aggression: 0.85, expansion: 0.6, science: 0.3, culture: 0.4 }),
        L('olav', 'Olav Tryggvason', 'King', 'Christening Sword', 'Capturing a settlement grants +100 Heritage. Shrines +2 Heritage. Naval units +4 Strength.', { captureCulture: 100, buildingBonus: { shrine: { culture: 2 } }, navalBonus: 4 }, { aggression: 0.7, expansion: 0.6, science: 0.4, culture: 0.6 })
      ] },
    ...
    { id: 'babylon', name: 'Babylon', adj: 'Babylonian', difficulty: 'medium', bias: ['river', 'marsh'], color: '#6c3483', color2: '#f8c471',
      ...
      leaders: [
        L('hammurabi', 'Hammurabi', 'King', 'Code of Laws', 'Your first Monument grants a free civic. +2 Heritage per settlement. Settlements +2 defense.', { freeCivicOnBuilding: 'monument', culturePerSettlement: 2, cityDefense: 2 }, { aggression: 0.4, expansion: 0.6, science: 0.7, culture: 0.7 }),
        L('nebuchadnezzar', 'Nebuchadnezzar II', 'King', 'Hanging Gardens', 'Settlements grow 20% faster. Wonders cost 15% less and each yields +1 Happiness.', { growthMult: 1.2, wonderCostMult: 0.85, happinessPerWonder: 1 }, { aggression: 0.5, expansion: 0.6, science: 0.6, culture: 0.7 })
      ] },
    ...
    { id: 'polynesia', name: 'Polynesia', adj: 'Polynesian', difficulty: 'hard', bias: ['coast'], color: '#148f77', color2: '#fad7a0',
      ...
      leaders: [
        L('kamehameha', 'Kamehameha', 'King', 'Unification of the Islands', 'Coastal settlements +2 Food and +1 Production. Units +4 Strength while on Coast water.', { coastalSettlementYields: { food: 2, production: 1 }, combatBonusCoast: 4 }, { aggression: 0.5, expansion: 0.7, science: 0.4, culture: 0.5 }),
        L('hotu', 'Hotu Matu\'a', 'Ariki', 'Moai', 'Each Wonder yields +3 Heritage. Coastal settlements +2 Heritage. Monuments +1 Heritage.', { culturePerWonder: 3, coastalSettlementYields: { culture: 2 }, buildingBonus: { monument: { culture: 1 } } }, { aggression: 0.3, expansion: 0.6, science: 0.4, culture: 0.8 })
      ] }
  ];
