...
(function (AU) {
  ...
  AU.TECHS = [
    ...
    T('calendar', 'Almanac', 1, 2, ['irrigation', 'mysticism'], ['Work a Plantation', ['improvement', 'plantation', 1]], { fx: { tileBonus: [{ when: 'plantation', yields: { culture: 1 } }] }, desc: 'Plantations yield +1 Culture.' }),
    ...
    T('paper', 'Papermaking', 2, 3, ['writing', 'calendar'], ['Learn 12 civics', ['civics', 12]], { fx: { yieldMult: { science: 1.05 } }, desc: '+5% Science.' }),
    ...
    T('scientific_method', 'Experiments', 3, 6, ['astronomy', 'printing'], ['Own 3 Universities', ['building', 'university', 3]], { fx: { yieldMult: { science: 1.05 } }, desc: '+5% Science.' }),
    ...
    T('telecommunications', 'Telephony', 5, 8, ['electronics', 'ideology_tech'], ['Own 3 Broadcast Towers', ['building', 'broadcast_tower', 3]], { fx: { yieldMult: { culture: 1.1 } }, desc: '+10% Culture.' }),
    // ---- Atomic
    ...
    T('television', 'Broadcast TV', 6, 5, ['telecommunications', 'computers'], ['Own 2 Stadiums', ['building', 'stadium', 2]], { fx: { happinessBonus: 1, yieldMult: { culture: 1.05 } }, desc: '+1 Happiness per settlement, +5% Culture.' }),
    ...
    T('nanotechnology', 'Nanomachines', 7, 5, ['robotics', 'genetics'], ['Own 4 Research Labs', ['building', 'research_lab', 4]], { fx: { yieldMult: { science: 1.1 } }, desc: '+10% Science.' }),
    T('artificial_intelligence', 'Thinking Machines', 7, 6, ['the_internet', 'robotics'], ['Own 5 Computer Centers… own 4 Computer Centers', ['building', 'computer_center', 4]], { fx: { yieldMult: { science: 1.1, gold: 1.1 } }, desc: '+10% Science and Gold.' }),
  ...
  AU.CIVICS = [
    ...
    C('social_media', "Viral Culture", 6, 5, ['professional_sports', 'globalization'], ['Research The Internet', ['tech', 'the_internet']], { fx: { yieldMult: { culture: 1.1 } }, cards: ['online_communities'] }),
    // Information
    ...
    C('cultural_hegemony', "Global Culture", 7, 5, ['social_media', 'corporate_libertarianism'], ['Own 4 Broadcast Towers', ['building', 'broadcast_tower', 4]], { fx: { culturePerSettlement: 2 } })
  ];
  ...
  AU.POLICIES = {
    ...
    inspiration_card: P('inspiration_card', 'Muse', 'wildcard', '+10% Culture.', { yieldMult: { culture: 1.1 } }),
