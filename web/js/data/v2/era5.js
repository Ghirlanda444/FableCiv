...
(function (AU) {
  ...
  node({ id: 'p_wire', pool: F, cat: 'Kinship', name: 'Copper Wire', joke: 'We Sent A Word Really Far, Really Fast', fx: { commandBonus: 2 }, trigger: { type: 'discovery', cond: ['met', 3], turns: 15, desc: 'Know three other empires for 15 turns' }, unlocks: { building: 'telegraph_office' } });
