...
(function (AU) {
  ...
  pair({ id: 'e_merchant_guild', name: 'Merchant Guild', joke: 'The Merchants Formed A Guild Too', trigger: { type: 'threshold', cond: ['met', 3], desc: 'Meet 3 empires' }, fx: { goldPerSettlement: 2 } },
       { id: 'e_artisan_guild', name: 'Artisan Guild', joke: 'The Artisans Formed A Guild Too', trigger: { type: 'threshold', cond: ['improvedTiles', 14], desc: 'Work 14 improved tiles' }, fx: { capitalYields: { production: 3 } } });
  ...
  pair({ id: 'e_musket_line', name: 'Musket Line', joke: 'Everybody Point The Same Direction', trigger: { type: 'threshold', cond: ['unitcls', 'melee', 4], desc: 'Own 4 melee units' }, fx: { combatBonus: 3 } },
  ...
  pair({ id: 'e_royal_charter', name: 'Royal Charter', joke: 'The Crown Signed Off On It, Probably', trigger: { type: 'threshold', cond: ['settlements', 5], desc: 'Found 5 settlements' }, fx: { settlerCostMult: 0.85 } },
       { id: 'e_private_ledger', name: 'Private Ledger', joke: "Nobody Else Gets To See This Book", trigger: { type: 'threshold', cond: ['military', 7], desc: 'Own 7 military units' }, fx: { freeUpkeep: 3 } });
