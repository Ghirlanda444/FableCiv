...
(function (AU) {
  ...
  pair({ id: 'm_clay_legion', name: 'Clay Legion', joke: 'An Army That Never Complains', trigger: { type: 'threshold', cond: ['unitsBuilt', 10], desc: 'Train 10 units' }, fx: { unitsStartXp: 5 }, unlocks: { wonder: 'terracotta_army' } },
       { id: 'm_living_legion', name: 'Living Legion', joke: 'We Just Used Real Guys', trigger: { type: 'threshold', cond: ['level', 2], desc: 'Have a unit reach level 2' }, fx: { combatBonus: 3, xpMult: 1.3 } });
  ...
  node({ id: 'm_war_college', pool: B, name: 'War College', joke: 'Legion Tactics, Now Written Down', fx: { commandBonus: 2 }, trigger: { type: 'threshold', cond: ['military', 8], desc: 'Own 8 military units' }, unlocks: { national: 'heroic_epic' } });
