...
(function (AU) {
  ...
  node({ id: 't_tannery', pool: F, cat: 'Craft', name: "Tanner's Yard", joke: 'Smells Terrible, Works Great', trigger: { type: 'threshold', cond: ['resourcekind', 'strategic', 1], desc: 'Own a strategic resource' }, fx: { unitCostMult: 0.9, scarecrowLevel: 1 } });
