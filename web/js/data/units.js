...
(function (AU) {
  AU.UNITS = {
    ...
    catapult:    { name: 'Stone Thrower',    cls: 'siege',    cost: 120, moves: 2, strength: 23, ranged: 35, range: 2, tech: 'engineering', resource: 'copper', icon: '🪨', upgradesTo: 'bombard' },
    galley:      { name: 'Oarship',      cls: 'naval',    cost: 65,  moves: 3, strength: 30, tech: 'sailing', icon: '⛵', upgradesTo: 'caravel' },
    crossbowman: { name: 'Arbalester', cls: 'ranged',   cost: 180, moves: 2, strength: 30, ranged: 40, range: 2, tech: 'machinery', resource: 'copper', icon: '🏹', upgradesTo: 'field_cannon' },
    ...
    tank:        { name: 'Land Cruiser',        cls: 'cavalry',  cost: 480, moves: 4, strength: 80, tech: 'combustion', resource: 'rubber', icon: '🛡️', upgradesTo: 'modern_armor' },
    mech_infantry:{ name: 'Mechanized Troops', cls: 'melee', cost: 560, moves: 3, strength: 90, tech: 'plastics', resource: 'oil', icon: '🚛' },
    rocket_artillery: { name: 'Rocket Battery', cls: 'siege', cost: 580, moves: 3, strength: 60, ranged: 95, range: 2, tech: 'rocketry', resource: 'aluminum', icon: '🚀' },
    ...
    submarine:   { name: 'Attack Sub',   cls: 'naval',    cost: 560, moves: 5, strength: 85, tech: 'radar', resource: 'uranium', icon: '🛥️', ocean: true },
    modern_armor:{ name: 'Heavy Armor', cls: 'cavalry', cost: 700, moves: 5, strength: 100, tech: 'composites', resource: 'uranium', icon: '🛡️' },
    special_forces:{ name: 'Commandos', cls: 'melee', cost: 640, moves: 3, strength: 95, tech: 'stealth', icon: '🥷' },
    fighter:     { name: 'Biplane',     cls: 'air',      cost: 420, moves: 8,  strength: 55, ranged: 60, range: 2, tech: 'flight', resource: 'rubber', icon: '✈️', flying: true, sight: 3, upgradesTo: 'jet_fighter', desc: 'Flies over any terrain and water; attacks from 2 tiles. Cannot capture.' },
    bomber:      { name: 'Heavy Bomber',      cls: 'air',      cost: 520, moves: 8,  strength: 45, ranged: 85, range: 2, tech: 'advanced_flight', resource: 'rubber', icon: '🛩️', flying: true, sight: 3, vsSettlements: 15, desc: 'Heavy bomber: flies over anything, +15 vs settlements. Cannot capture.' },
    jet_fighter: { name: 'Jet Interceptor', cls: 'air',      cost: 680, moves: 10, strength: 90, ranged: 95, range: 2, tech: 'jet_engines', resource: 'aluminum', icon: '🛫', flying: true, sight: 4, desc: 'Fast jet: flies over anything, attacks from 2 tiles. Cannot capture.' },
