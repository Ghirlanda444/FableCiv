...
(function (AU) {
  ...
  AU.CITY_STATES = [
    ...
    S('samarkand', 'Samarkand', 'trade', '#d35400', 'Silk Road', 'Patron: +3 Gold and +1 Science in the capital, town purchases 15% cheaper.', { capitalYields: { gold: 3, science: 1 }, townPurchaseMult: 0.85 }),
    ...
    S('geneva', 'Geneva', 'science', '#95a5a6', 'Neutrality', 'Patron: +15% Science while not at war.', { peaceScienceMult: 1.15 }),
    S('nalanda', 'Nalanda', 'science', '#f39c12', 'Great Library of the East', 'Patron: Libraries +2 Science.', { buildingBonus: { library: { science: 2 } } }),
    S('bologna', 'Bologna', 'science', '#8e44ad', 'Alma Mater', 'Patron: Universities +3 Science.', { buildingBonus: { university: { science: 3 } } }),
    S('mitla', 'Mitla', 'science', '#27ae60', 'Place of the Dead', 'Patron: +1 Science per settlement.', { sciencePerSettlement: 1 }),
    S('anshan', 'Anshan', 'science', '#34495e', 'Elamite Scribes', 'Patron: each technology learned grants +20 Gold.', { techGold: 20 }),
    S('kumasi', 'Kumasi', 'culture', '#f1c40f', 'Golden Stool', 'Patron: +1 Culture per settlement and +1 Happiness in the capital.', { culturePerSettlement: 1, capitalYields: { happiness: 1 } }),
    S('vilnius', 'Vilnius', 'culture', '#1abc9c', 'Gates of Dawn', 'Patron: +10% Culture.', { yieldMult: { culture: 1.1 } }),
    S('nan_madol', 'Nan Madol', 'culture', '#3498db', 'Stone City on the Reef', 'Patron: coastal settlements +2 Culture.', { coastalSettlementYields: { culture: 2 } }),
    S('antananarivo', 'Antananarivo', 'culture', '#e67e22', 'Highland Kingdom', 'Patron: Monuments and Amphitheaters +1 Culture.', { buildingBonus: { monument: { culture: 1 }, amphitheater: { culture: 1 } } }),
    S('mohenjo_daro', 'Mohenjo-Daro', 'culture', '#c39bd3', 'Great Bath', 'Patron: settlements on rivers +1 Culture and +1 Happiness.', { settlementSiteBonus: [{ when: 'river', yields: { culture: 1, happiness: 1 } }] }),
    S('jerusalem', 'Jerusalem', 'religious', '#ecf0f1', 'Holy Land', 'Patron: your religion spreads 50% farther and stronger.', { pressureMult: 0.5 }),
    S('yerevan', 'Yerevan', 'religious', '#a04000', 'Mount Ararat', 'Patron: religious units cost 25% less Faith and have +10 debate strength.', { religiousUnitCostMult: 0.75, religiousStrength: 10 }),
    S('armagh', 'Armagh', 'religious', '#229954', 'Saint Patrick', 'Patron: Shrines +2 Faith.', { buildingBonus: { shrine: { faith: 2 } } }),
    S('lhasa', 'Lhasa', 'religious', '#b03a2e', 'Roof of the World', 'Patron: +1 Faith per settlement and Temples +1 Happiness.', { faithPerSettlement: 1, buildingBonus: { temple: { happiness: 1 } } }),
    S('kandy', 'Kandy', 'religious', '#0e6655', 'Temple of the Tooth', 'Patron: +2 Faith per Natural Wonder inside your borders.', { faithPerNaturalWonder: 2 }),
    S('chinguetti', 'Chinguetti', 'religious', '#d4ac0d', 'Desert Libraries', 'Patron: worked Desert tiles +1 Faith and +1 Science.', { tileBonus: [{ when: 'desert', yields: { faith: 1, science: 1 } }] }),
