...
(function (AU) {
  ...
  AU.NATURAL_WONDERS = {
    ...
    matterhorn:  { name: 'Matterhorn',           terrain: 'mountain', yields: { culture: 4 }, adjacent: { culture: 1 }, icon: '🏔️', desc: 'The most photographed peak. Adjacent worked tiles +1 Heritage.', style: 'peak' },
    uluru:       { name: 'Uluru',                terrain: 'desert', flat: true, yields: { food: 2, culture: 3 }, adjacent: { culture: 1 }, icon: '🪨', desc: 'A red monolith sacred to the peoples around it. Adjacent worked tiles +1 Heritage.', style: 'monolith' },
    ...
    danxia:      { name: 'Zhangye Danxia',       terrain: 'desert', hills: true, yields: { gold: 3, culture: 2 }, adjacent: { culture: 1 }, icon: '🌄', desc: 'Rainbow-striped sandstone hills. Adjacent worked tiles +1 Heritage.', style: 'cliffs' },
    ...
    galapagos:   { name: 'Galápagos',            terrain: 'coast', yields: { science: 5 }, adjacent: { science: 1 }, icon: '🐢', desc: 'Where the theory of evolution was born. Adjacent worked tiles +1 Knowledge.', style: 'reef' },
    ...
    cliffs_dover:{ name: 'Cliffs of Dover',      terrain: 'coast', yields: { culture: 3, gold: 2 }, adjacent: { culture: 1 }, icon: '🏝️', desc: 'White chalk walls facing the sea. Adjacent worked tiles +1 Heritage.', style: 'cliffs' }
  };
  AU.MAP_SIZES = {
