...
items.push({ kind: 'keyart', id: 'title_portrait', name: 'Title key art (portrait, phone)', size: '864x1536', nobg: true, hires: true, prompt: `Tall vertical phone-screen key art for a cute chibi civilization strategy game, ${KEYART_SCENE}, the characters fill the lower half and the castle and sky fill the upper half. Absolutely no text, no letters, no logo, no user interface, no watermark, no border. ${SCENE_STYLE}` });
items.push({ kind: 'logo', id: 'chibilization', name: 'Logo', size: '1024x512', prompt: `Mobile game title logo: the single word "CHIBILIZATION" written in big chunky rounded 3D golden cartoon letters with a thick dark brown outline, glossy bevelled toy-like lettering, slightly arched, a tiny golden crown sitting on the first letter and two small green laurel leaves at the sides, in the style of Clash of Clans and Kingshot game logos. The word must be spelled exactly C-H-I-B-I-L-I-Z-A-T-I-O-N with no other words, no tagline, no subtitle. Centred, isolated on a plain white background, no watermark.` });
